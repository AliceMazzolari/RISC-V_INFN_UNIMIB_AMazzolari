...
module DDR_imp_10J4PB3
  ...
  assign MEM_AXI4_ARADDR = S_AXI_araddr[33:0];
  ...
  assign MEM_AXI4_AWADDR = S_AXI_awaddr[33:0];
...
module IO_imp_44488Y
  ...
  wire AXI_clock;
  wire AXI_reset;
  wire [3:0]Conn1_TRI_O;
  wire EthernetMII_COL;
  wire EthernetMII_CRS;
  wire [3:0]EthernetMII_RXD;
  wire EthernetMII_RX_CLK;
  wire EthernetMII_RX_DV;
  wire EthernetMII_RX_ER;
  wire [3:0]EthernetMII_TXD;
  wire EthernetMII_TX_CLK;
  wire EthernetMII_TX_EN;
  ...
  wire [8:0]io_axi_s_M04_AXI_ARADDR;
  wire io_axi_s_M04_AXI_ARREADY;
  wire io_axi_s_M04_AXI_ARVALID;
  wire [8:0]io_axi_s_M04_AXI_AWADDR;
  wire io_axi_s_M04_AXI_AWREADY;
  wire io_axi_s_M04_AXI_AWVALID;
  wire io_axi_s_M04_AXI_BREADY;
  wire [1:0]io_axi_s_M04_AXI_BRESP;
  wire io_axi_s_M04_AXI_BVALID;
  wire [31:0]io_axi_s_M04_AXI_RDATA;
  wire io_axi_s_M04_AXI_RREADY;
  wire [1:0]io_axi_s_M04_AXI_RRESP;
  wire io_axi_s_M04_AXI_RVALID;
  wire [31:0]io_axi_s_M04_AXI_WDATA;
  wire io_axi_s_M04_AXI_WREADY;
  wire [3:0]io_axi_s_M04_AXI_WSTRB;
  wire io_axi_s_M04_AXI_WVALID;
  wire [4:0]io_axi_s_M05_AXI_ARADDR;
  wire io_axi_s_M05_AXI_ARREADY;
  wire io_axi_s_M05_AXI_ARVALID;
  wire [4:0]io_axi_s_M05_AXI_AWADDR;
  wire io_axi_s_M05_AXI_AWREADY;
  wire io_axi_s_M05_AXI_AWVALID;
  wire io_axi_s_M05_AXI_BREADY;
  wire [1:0]io_axi_s_M05_AXI_BRESP;
  wire io_axi_s_M05_AXI_BVALID;
  wire [31:0]io_axi_s_M05_AXI_RDATA;
  wire io_axi_s_M05_AXI_RREADY;
  wire [1:0]io_axi_s_M05_AXI_RRESP;
  wire io_axi_s_M05_AXI_RVALID;
  wire [31:0]io_axi_s_M05_AXI_WDATA;
  wire io_axi_s_M05_AXI_WREADY;
  wire [3:0]io_axi_s_M05_AXI_WSTRB;
  wire io_axi_s_M05_AXI_WVALID;
  ...
  assign AXI_clock = axi_clock;
  assign AXI_reset = axi_reset;
  assign EthernetMII_COL = MII_col;
  assign EthernetMII_CRS = MII_crs;
  assign EthernetMII_RXD = MII_rxd[3:0];
  assign EthernetMII_RX_CLK = MII_rx_clk;
  assign EthernetMII_RX_DV = MII_rx_dv;
  assign EthernetMII_RX_ER = MII_rx_er;
  assign EthernetMII_TX_CLK = MII_tx_clk;
  assign GPIO_0_tri_o[3:0] = Conn1_TRI_O;
  assign MII_tx_en = EthernetMII_TX_EN;
  assign MII_txd[3:0] = EthernetMII_TXD;
  assign M_AXI_araddr[33:0] = io_axi_m_ARADDR;
  ...
  assign M_AXI_awaddr[33:0] = io_axi_m_AWADDR;
  ...
  assign convst_in_0_1 = convst_in_0;
  ...
  riscv_axi_gpio_0_0 AXI_GPIO_LED
       (.gpio_io_o(Conn1_TRI_O),
        .s_axi_aclk(clock_100MHz),
        .s_axi_araddr(io_axi_s_M04_AXI_ARADDR),
        .s_axi_aresetn(AXI_reset),
        .s_axi_arready(io_axi_s_M04_AXI_ARREADY),
        .s_axi_arvalid(io_axi_s_M04_AXI_ARVALID),
        .s_axi_awaddr(io_axi_s_M04_AXI_AWADDR),
        .s_axi_awready(io_axi_s_M04_AXI_AWREADY),
        .s_axi_awvalid(io_axi_s_M04_AXI_AWVALID),
        .s_axi_bready(io_axi_s_M04_AXI_BREADY),
        .s_axi_bresp(io_axi_s_M04_AXI_BRESP),
        .s_axi_bvalid(io_axi_s_M04_AXI_BVALID),
        .s_axi_rdata(io_axi_s_M04_AXI_RDATA),
        .s_axi_rready(io_axi_s_M04_AXI_RREADY),
        .s_axi_rresp(io_axi_s_M04_AXI_RRESP),
        .s_axi_rvalid(io_axi_s_M04_AXI_RVALID),
        .s_axi_wdata(io_axi_s_M04_AXI_WDATA),
        .s_axi_wready(io_axi_s_M04_AXI_WREADY),
        .s_axi_wstrb(io_axi_s_M04_AXI_WSTRB),
        .s_axi_wvalid(io_axi_s_M04_AXI_WVALID));
  ...
  riscv_XADC_0 XADC
       (.convst_in(convst_in_0_1),
        ...
        .vn_in(1'b0),
        .vp_in(1'b0));
  riscv_axi_timer_0_1 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
        .interrupt(axi_timer_0_interrupt),
        .s_axi_aclk(clock_100MHz),
        .s_axi_araddr(io_axi_s_M05_AXI_ARADDR),
        .s_axi_aresetn(AXI_reset),
        .s_axi_arready(io_axi_s_M05_AXI_ARREADY),
        .s_axi_arvalid(io_axi_s_M05_AXI_ARVALID),
        .s_axi_awaddr(io_axi_s_M05_AXI_AWADDR),
        .s_axi_awready(io_axi_s_M05_AXI_AWREADY),
        .s_axi_awvalid(io_axi_s_M05_AXI_AWVALID),
        .s_axi_bready(io_axi_s_M05_AXI_BREADY),
        .s_axi_bresp(io_axi_s_M05_AXI_BRESP),
        .s_axi_bvalid(io_axi_s_M05_AXI_BVALID),
        .s_axi_rdata(io_axi_s_M05_AXI_RDATA),
        .s_axi_rready(io_axi_s_M05_AXI_RREADY),
        .s_axi_rresp(io_axi_s_M05_AXI_RRESP),
        .s_axi_rvalid(io_axi_s_M05_AXI_RVALID),
        .s_axi_wdata(io_axi_s_M05_AXI_WDATA),
        .s_axi_wready(io_axi_s_M05_AXI_WREADY),
        .s_axi_wstrb(io_axi_s_M05_AXI_WSTRB),
        .s_axi_wvalid(io_axi_s_M05_AXI_WVALID));
  riscv_ethernet_stream_0_0 ethernet_stream_0
       (.clock(clock_100MHz),
        .mii_col(EthernetMII_COL),
        .mii_crs(EthernetMII_CRS),
        .mii_rx_clk(EthernetMII_RX_CLK),
        .mii_rx_dv(EthernetMII_RX_DV),
        .mii_rx_er(EthernetMII_RX_ER),
        .mii_rxd(EthernetMII_RXD),
        .mii_tx_clk(EthernetMII_TX_CLK),
        .mii_tx_en(EthernetMII_TX_EN),
        .mii_txd(EthernetMII_TXD),
        .reset(Ethernet_reset),
        .rx_axis_tdata(ethernet_stream_0_RX_AXIS_TDATA),
        .rx_axis_tkeep(ethernet_stream_0_RX_AXIS_TKEEP),
        .rx_axis_tlast(ethernet_stream_0_RX_AXIS_TLAST),
  ...
  riscv_io_axi_s_0 io_axi_s
       (.M00_AXI_araddr(io_axi_s_M00_AXI_ARADDR),
        ...
        .M04_AXI_araddr(io_axi_s_M04_AXI_ARADDR),
        .M04_AXI_arready(io_axi_s_M04_AXI_ARREADY),
        .M04_AXI_arvalid(io_axi_s_M04_AXI_ARVALID),
        .M04_AXI_awaddr(io_axi_s_M04_AXI_AWADDR),
        .M04_AXI_awready(io_axi_s_M04_AXI_AWREADY),
        .M04_AXI_awvalid(io_axi_s_M04_AXI_AWVALID),
        .M04_AXI_bready(io_axi_s_M04_AXI_BREADY),
        .M04_AXI_bresp(io_axi_s_M04_AXI_BRESP),
        .M04_AXI_bvalid(io_axi_s_M04_AXI_BVALID),
        .M04_AXI_rdata(io_axi_s_M04_AXI_RDATA),
        .M04_AXI_rready(io_axi_s_M04_AXI_RREADY),
        .M04_AXI_rresp(io_axi_s_M04_AXI_RRESP),
        .M04_AXI_rvalid(io_axi_s_M04_AXI_RVALID),
        .M04_AXI_wdata(io_axi_s_M04_AXI_WDATA),
        .M04_AXI_wready(io_axi_s_M04_AXI_WREADY),
        .M04_AXI_wstrb(io_axi_s_M04_AXI_WSTRB),
        .M04_AXI_wvalid(io_axi_s_M04_AXI_WVALID),
        .M05_AXI_araddr(io_axi_s_M05_AXI_ARADDR),
        .M05_AXI_arready(io_axi_s_M05_AXI_ARREADY),
        .M05_AXI_arvalid(io_axi_s_M05_AXI_ARVALID),
        .M05_AXI_awaddr(io_axi_s_M05_AXI_AWADDR),
        .M05_AXI_awready(io_axi_s_M05_AXI_AWREADY),
        .M05_AXI_awvalid(io_axi_s_M05_AXI_AWVALID),
        .M05_AXI_bready(io_axi_s_M05_AXI_BREADY),
        .M05_AXI_bresp(io_axi_s_M05_AXI_BRESP),
        .M05_AXI_bvalid(io_axi_s_M05_AXI_BVALID),
        .M05_AXI_rdata(io_axi_s_M05_AXI_RDATA),
        .M05_AXI_rready(io_axi_s_M05_AXI_RREADY),
        .M05_AXI_rresp(io_axi_s_M05_AXI_RRESP),
        .M05_AXI_rvalid(io_axi_s_M05_AXI_RVALID),
        .M05_AXI_wdata(io_axi_s_M05_AXI_WDATA),
        .M05_AXI_wready(io_axi_s_M05_AXI_WREADY),
        .M05_AXI_wstrb(io_axi_s_M05_AXI_WSTRB),
        .M05_AXI_wvalid(io_axi_s_M05_AXI_WVALID),
  ...
  riscv_xlconstant_0_0 xlconstant_0
       (.dout(Ethernet_mdio_int));
endmodule

(* CORE_GENERATION_INFO = "riscv,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=riscv,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "riscv.hwdef" *) 
module riscv
   (convst_in_0,
    ddr3_sdram_addr,
    ddr3_sdram_ba,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth COL" *) input eth_col;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth CRS" *) input eth_crs;
  output eth_mdio_clock;
  inout eth_mdio_data;
  output eth_mdio_reset;
  output eth_ref_clock;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth RX_CLK" *) input eth_rx_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth RX_DV" *) input eth_rx_dv;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth RX_ER" *) input eth_rx_er;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth RXD" *) input [3:0]eth_rxd;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth TX_CLK" *) input eth_tx_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth TX_EN" *) output eth_tx_en;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mii:1.0 eth TXD" *) output [3:0]eth_txd;
  ...
  assign IO_MII_COL = eth_col;
  assign IO_MII_CRS = eth_crs;
  assign IO_MII_RXD = eth_rxd[3:0];
  assign IO_MII_RX_CLK = eth_rx_clk;
  assign IO_MII_RX_DV = eth_rx_dv;
  assign IO_MII_RX_ER = eth_rx_er;
  assign IO_MII_TX_CLK = eth_tx_clk;
  ...
  assign ddr3_sdram_cs_n[0] = DDR_ddr3_sdram_CS_N;
  ...
  assign eth_ref_clock = clock_25MHz;
  assign eth_tx_en = IO_MII_TX_EN;
  assign eth_txd[3:0] = IO_MII_TXD;
  assign leds_4bits_tri_o[3:0] = IO_GPIO_0_TRI_O;
  ...
  DDR_imp_10J4PB3 DDR
       (.S_AXI_araddr(MEM_AXI4_ARADDR),
        ...
        .ddr3_sdram_cs_n(DDR_ddr3_sdram_CS_N),
        ...
        .sys_reset(reset_h));
  IO_imp_44488Y IO
       (.GPIO_0_tri_o(IO_GPIO_0_TRI_O),
        .MII_col(IO_MII_COL),
        .MII_crs(IO_MII_CRS),
        .MII_rx_clk(IO_MII_RX_CLK),
        .MII_rx_dv(IO_MII_RX_DV),
        .MII_rx_er(IO_MII_RX_ER),
        .MII_rxd(IO_MII_RXD),
        .MII_tx_clk(IO_MII_TX_CLK),
        .MII_tx_en(IO_MII_TX_EN),
        .MII_txd(IO_MII_TXD),
